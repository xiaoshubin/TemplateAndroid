 ...
 * xml:
 *
 <com.smallcake.utils.custom.CirclePercentView
 ...
 app:circleStartColor="@color/white"
 app:circleEndColor="@color/white"
 app:circleProgressColor="@color/white" />

 java：
 无动画
    circleView.setPercentage(progress);
自定义有动画
...
public class CirclePercentView extends View {
    ...
    public CirclePercentView(Context context, @Nullable AttributeSet attrs) {
        ...
        bgColor = typedArray.getColor(R.styleable.CirclePercentView_circleBgColor, getResources().getColor(R.color.gray));
        progressColor = typedArray.getColor(R.styleable.CirclePercentView_circleProgressColor, getResources().getColor(R.color.orange));
        radius = typedArray.getInt(R.styleable.CirclePercentView_circleRadiu, WIDTH_RADIUS_RATIO);
        isGradient = typedArray.getBoolean(R.styleable.CirclePercentView_circleIsGradient, false);
        startColor = typedArray.getColor(R.styleable.CirclePercentView_circleStartColor, getResources().getColor(R.color.black));
        endColor = typedArray.getColor(R.styleable.CirclePercentView_circleEndColor, getResources().getColor(R.color.black));
        typedArray.recycle();
        init();
    }
